...
if(!function_exists ('ew_pagination')){
	function ew_pagination($num_pages_per_phrase = 3){
		...
		<div class="wp-pagenavi">	
			...
			<?php
			if($paged > 1){?>
			<a class="first" href="<?php echo $pageLink;?><?php echo 'paged=1'; //first link ?>"><?php _e('First','wpdance')?></a>
			<a class="previous" href="<?php echo $pageLink;?><?php echo 'paged=' . ($paged - 1); //next link ?>"><?php _e('Previous','wpdance')?></a>
			<?php }
			if($phrase > 1){?>
			...
			<?php if($paged < $wp_query->max_num_pages){?>
					<a class="next" href="<?php echo $pageLink;?><?php echo 'paged=' . ($paged + 1); //next link ?>"><?php _e('Next','wpdance')?></a>
					<a class="last" href="<?php echo $pageLink;?><?php echo 'paged=' . $wp_query->max_num_pages; //next link ?>"><?php _e('Last','wpdance')?></a>
			<?php }?>
