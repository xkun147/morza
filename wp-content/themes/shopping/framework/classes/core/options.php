	...
	class WPO_Option{
		...
		public function getOption( $suboptions=array() ){
		    ...
		    $general[] = array(
		        ...
		        'id' => 'copyright',
		        'type' => 'editor',
		        'std' =>'© 2014 <a href="http://pavodemo.com/wpopal/shopping/">Shopping Theme</a> POWERED BY <a href="http://themeforest.net/user/Opal_WP/?ref=dancof">OpalTheme</a>/ Buy it on <a href="http://themeforest.net/user/Opal_WP/portfolio?ref=dancof">ThemeForest</a>.',
		        'settings' => $wp_editor_settings );
