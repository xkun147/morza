<?php
	...
	function datas_config($data = array()){
		//global $data;
		$data = $data['data'];
		if($data && isset($data['wd_menu_num_widget']) && isset($data['wd_menu_thumb_width']) && isset($data['wd_menu_thumb_height']) && isset($data['wd_menu_text'])){
