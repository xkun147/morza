...
<div class="social_sharing">
	<div class="social-des">
		<h6 class="title-social"><?php echo $_sharing_title = sprintf( __( '%s','wpdance' ), stripslashes(esc_attr($wd_data['wd_prod_share_title'])) ) ;?></h6>
	...
	<div class="social_icon">	
		...
		<?php echo stripslashes(htmlspecialchars_decode($wd_data["wd_prod_share_code"]));?>
